...
MAX_RETRY = 5
service  = 'CpsMonitor'  
start_time_str ,end_time_str = '2026-03-20 17:21:00' , '2026-03-20 17:25:00'
report_types  = [
                'HistoryOrder',
                'AnpayOrder'
                ]
            ...
            for _id in ids:    
                ...
                for retry in range(MAX_RETRY):
                    try:
                        ...
                        logger.info("download success", extra={"event": "end","status": "ok","report_id": report_id,"file_name": filename,"counts":len(df)})
                        break
                    except Exception:
